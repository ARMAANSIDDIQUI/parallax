  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'radial-gradient(circle at 50% 0%, rgba(16, 185, 129, 0.15) 0%, transparent 70%)'
        }}
      />

      {/* Faint glowing ribbon trail from previous section */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-64 bg-gradient-to-b from-emerald-500/10 to-transparent blur-3xl pointer-events-none z-0" />
